...
EXP_DIR="${2:-$ROOT/exp/stageA2/377_multiview_explicit_hq_v4_softmask_dualmask_resume_v1}"
...
exec env PYTHONUNBUFFERED=1 "$PYTHON_BIN" "$ROOT/tools/run_377_stageA2_multiview_explicit.py" \
  ...
  --option stageA_377_multiview_explicit_hq_v4_softmask_dualmask_resume_v1 \
