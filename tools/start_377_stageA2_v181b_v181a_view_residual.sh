...
EXP_DIR="$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v181b_v181a_view_residual_screen2500"
START_CKPT="$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v181a_v179c_camera_affine_screen2500/best_ckpt.pth"
ITERATIONS="2500"
...
exec env PYTHONUNBUFFERED=1 "$PYTHON_BIN" "$ROOT/tools/run_377_stageA2_multiview_explicit.py" \
  ...
  --option stageA_377_multiview_explicit_hq_v181b_v181a_view_residual_v1 \
