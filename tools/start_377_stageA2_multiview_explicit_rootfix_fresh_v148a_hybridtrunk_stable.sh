...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_fresh_v148a_v136a_earlyfresh_hybridtrunk_stable_screen4k}"
ITERATIONS="${2:-4000}"
if [ "$#" -ge 2 ]; then
  shift 2
else
...
exec env PYTHONUNBUFFERED=1 "$PYTHON_BIN" "$ROOT/tools/run_377_stageA2_multiview_explicit.py" \
  ...
  --option stageA_377_multiview_explicit_hq_v148a_v136a_earlyfresh_hybridtrunk_stable_v1 \
