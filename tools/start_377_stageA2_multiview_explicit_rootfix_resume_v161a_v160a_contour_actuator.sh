...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v161a_v160a_contour_actuator_screen1500_r1}"
...
exec "$ROOT/tools/start_377_stageA2_multiview_explicit_rootfix_resume_v160a_v158a_cfinish.sh" \
  ...
  "$START_CKPT" \
  "$ITERATIONS" \
  --option stageA_377_multiview_explicit_hq_v161a_v160a_contour_actuator_v1 \
  "$@"
