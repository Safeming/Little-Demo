...
RUN_ID="${RUN_ID:-v391_directional_split_opacity_residual_$(TZ=Asia/Shanghai date '+%Y%m%d_%H%M%S_bjt')}"
EXP_DIR="${EXP_DIR:-$ROOT/exp/formal/377_v391_directional_split_opacity_residual_${RUN_ID}}"
LOG_DIR="${LOG_DIR:-$ROOT/exp/formal/logs/377_v391_directional_split_opacity_residual_${RUN_ID}}"
...
SELECTOR_SUMMARY="$LOG_DIR/v391_raw_contour_checkpoint_summary.tsv"
SELECTED_JSON="$LOG_DIR/v391_selected_checkpoint.json"
...
CONFIG_CONTRACT=raw_gate_base_config_consistent_with_directional_split_opacity_residual
INFO
...
for ckpt in "${checkpoints[@]}"; do
  ...
  iter="${ckpt_name#ckpt}"
  gate_run_id="formal_377_v391_${ckpt_name}_raw_gate_${RUN_ID}"
  ...
  variant="candidate_v391_${ckpt_name}_directional_split_opacity_residual"
...
payload = {
    "selector": "strict_raw_contour_then_inner_v391_directional_split_opacity",
