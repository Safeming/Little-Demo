...
RUN_ID="${RUN_ID:-v343_component_direction_guard_$(TZ=Asia/Shanghai date '+%Y%m%d_%H%M%S_bjt')}"
EXP_ROOT="${EXP_ROOT:-$ROOT/exp/stageB/377_explicit_binding_v343_component_direction_guard_${RUN_ID}}"
LOG_DIR="${LOG_DIR:-$ROOT/exp/stageB/logs/377_explicit_binding_v343_component_direction_guard_${RUN_ID}}"
...
WINDOW_SPECS="${WINDOW_SPECS:-c21_f480_481|[21]|[480,481,1];c22_f240_241|[22]|[240,241,1];c23_f000_001|[23]|[0,1,1];c23_f278_279|[23]|[278,279,1];c22_f319_320|[22]|[319,320,1]}"
...
COMPONENT_DIRECTION_GUARD_IMAGES="${COMPONENT_DIRECTION_GUARD_IMAGES:-c21_f000480,c22_f000240,c23_f000000,c23_f000278,c21_f000161,c22_f000319,c23_f000295,c23_f000300,c23_f000298,c22_f000144,c21_f000123,c22_f000213,c22_f000001,c21_f000267,c21_f000135}"
...
run_window() {
  ...
  render_and_analyze "$window" "$views_spec" "$frames_spec" v341_point_screen_guard "$CANDIDATE_CKPT" "$window_root/v341_point_screen_guard" \
    "++explicit_binding_render_preset=v338_temporal_selector_grow_only_guard" \
    "++explicit_binding_adopted_signed_point_screen_actuator_drop_images='$POINT_SCREEN_DROP_IMAGES'"

  render_and_analyze "$window" "$views_spec" "$frames_spec" v343_drop_dynamic_outer "$CANDIDATE_CKPT" "$window_root/v343_drop_dynamic_outer" \
    "++explicit_binding_render_preset=v338_temporal_selector_grow_only_guard" \
    "++explicit_binding_adopted_signed_point_screen_actuator_drop_images='$POINT_SCREEN_DROP_IMAGES'" \
    "++explicit_binding_adopted_signed_dynamic_over_drop_images='$COMPONENT_DIRECTION_GUARD_IMAGES'"

  render_and_analyze "$window" "$views_spec" "$frames_spec" v343_drop_dynamic_inner "$CANDIDATE_CKPT" "$window_root/v343_drop_dynamic_inner" \
    "++explicit_binding_render_preset=v338_temporal_selector_grow_only_guard" \
    "++explicit_binding_adopted_signed_point_screen_actuator_drop_images='$POINT_SCREEN_DROP_IMAGES'" \
    "++explicit_binding_adopted_signed_dynamic_under_drop_images='$COMPONENT_DIRECTION_GUARD_IMAGES'"

  render_and_analyze "$window" "$views_spec" "$frames_spec" v343_drop_dynamic_both "$CANDIDATE_CKPT" "$window_root/v343_drop_dynamic_both" \
    "++explicit_binding_render_preset=v338_temporal_selector_grow_only_guard" \
    "++explicit_binding_adopted_signed_point_screen_actuator_drop_images='$POINT_SCREEN_DROP_IMAGES'" \
    "++explicit_binding_adopted_signed_dynamic_over_drop_images='$COMPONENT_DIRECTION_GUARD_IMAGES'" \
    "++explicit_binding_adopted_signed_dynamic_under_drop_images='$COMPONENT_DIRECTION_GUARD_IMAGES'"
...
variants = [
    "baseline_no_preset",
    "formal_v338_current",
    "v341_point_screen_guard",
    "v343_drop_dynamic_outer",
    "v343_drop_dynamic_inner",
    "v343_drop_dynamic_both",
]
...
echo "COMPONENT_DIRECTION_GUARD_IMAGES=$COMPONENT_DIRECTION_GUARD_IMAGES"
