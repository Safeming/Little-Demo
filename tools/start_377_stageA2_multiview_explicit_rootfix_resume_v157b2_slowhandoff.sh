...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v157b2_v157a_ownerhf_slowhandoff_screen3k}"
START_CKPT="${2:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_fresh_v157a_v152a_supportmain_screen4k/best_ckpt.pth}"
ITERATIONS="${3:-3000}"
if [ "$#" -ge 3 ]; then
  shift 3
else
...
exec env PYTHONUNBUFFERED=1 "$PYTHON_BIN" "$ROOT/tools/run_377_stageA2_multiview_explicit.py" \
  ...
  --option stageA_377_multiview_explicit_hq_v157b2_v157a_ownerhf_slowhandoff_v1 \
