...
QUEUE_ROOT="${1:-$ROOT/exp/comparisons/v143ab_queue_$(date +%Y%m%d_%H%M%S)}"
ITERATIONS="${2:-4000}"
...
run_one \
  "v143a_boundaryresfield_anchor" \
  "stageA_377_multiview_explicit_hq_v143a_v142e_boundaryresfield_anchor_v1" \
  "$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_fresh_v143a_v142e_boundaryresfield_anchor_resume" \
  "$@"

run_one \
  "v143b_boundaryresfield_xbar" \
  "stageA_377_multiview_explicit_hq_v143b_v142e_boundaryresfield_xbar_v1" \
  "$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_fresh_v143b_v142e_boundaryresfield_xbar_resume" \
  "$@"
