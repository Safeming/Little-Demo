...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v166c_v165_identity_continuation_screen2500}"
...
exec "$ROOT/tools/start_377_stageA2_multiview_explicit_rootfix_resume_v165_v164b_framebalanced_camquality.sh" \
  ...
  "$START_CKPT" \
  "$ITERATIONS" \
  --option stageA_377_multiview_explicit_hq_v166c_v165_resume_identity_continuation_v1 \
  "$@"
