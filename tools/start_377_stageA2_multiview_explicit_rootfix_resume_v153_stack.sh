...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v153_stack}"
START_CKPT="${2:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_fresh_v152a_v151_geomlearn_probe_screen4k/best_ckpt.pth}"
ITERATIONS="${3:-4000}"
if [ "$#" -ge 3 ]; then
  shift 3
else
