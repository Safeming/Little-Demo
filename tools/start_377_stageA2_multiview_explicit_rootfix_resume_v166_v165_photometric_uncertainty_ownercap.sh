...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v166_v165_photometric_uncertainty_ownercap_screen1500}"
...
exec "$ROOT/tools/start_377_stageA2_multiview_explicit_rootfix_resume_v165_v164b_framebalanced_camquality.sh" \
  ...
  "$START_CKPT" \
  "$ITERATIONS" \
  --option stageA_377_multiview_explicit_hq_v166_v165_photometric_uncertainty_ownercap_v1 \
  "$@"
