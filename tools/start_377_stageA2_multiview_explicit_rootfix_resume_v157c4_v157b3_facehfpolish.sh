...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v157c4_v157b3_facehfpolish_screen1p5k}"
...
exec "$ROOT/tools/start_377_stageA2_multiview_explicit_rootfix_resume_v157b3_midhandoff.sh" \
  ...
  "$START_CKPT" \
  "$ITERATIONS" \
  --option stageA_377_multiview_explicit_hq_v157c4_v157b3_facehfpolish_v1 \
  "$@"
