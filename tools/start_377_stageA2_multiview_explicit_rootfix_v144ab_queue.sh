...
QUEUE_ROOT="${1:-$ROOT/exp/comparisons/v144ab_queue_$(date +%Y%m%d_%H%M%S)}"
ITERATIONS="${2:-4000}"
...
run_one \
  "v144a_signed_regrow_resume" \
  "stageA_377_multiview_explicit_hq_v144a_v142e_signed_regrow_resume_v1" \
  "$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_fresh_v144a_v142e_signed_regrow_resume"

run_one \
  "v144b_forwardresidual_nodetach" \
  "stageA_377_multiview_explicit_hq_v144b_v144a_forwardresidual_nodetach_v1" \
  "$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_fresh_v144b_v144a_forwardresidual_nodetach_resume"
