...
cd "$ROOT"
"$PYTHON_BIN" "$ROOT/tools/run_377_stageA2_multiview_explicit.py"   --exp-dir "$EXP_DIR"   --texture shallow_mlp   --option stageA_377_multiview_explicit_hq_v4   --option stageA_377_multiview_explicit_hq_v4_silhouette_opacity_refine_v1   --extra-override "start_checkpoint=$START_CKPT"   "$@"
