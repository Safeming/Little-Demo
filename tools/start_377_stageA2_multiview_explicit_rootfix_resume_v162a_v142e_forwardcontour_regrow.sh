...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v162a_v142e_forwardcontour_regrow_screen2500}"
...
exec "$ROOT/tools/start_377_stageA2_multiview_explicit_rootfix_fresh_v139a_v136a_boundarygeom_errordriven.sh" \
  ...
  --option stageA_377_multiview_explicit_hq_v162a_v142e_forwardcontour_regrow_v1 \
  "$@"
