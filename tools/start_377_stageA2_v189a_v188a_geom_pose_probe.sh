...
BASE_EXP="$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v188a_v187b_geom_perceptual_texture_restore_20260508_v188a_geom_tex_restore"
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v189a_v188a_geom_pose_probe_$RUN_ID}"
...
exec env PYTHONUNBUFFERED=1 "$PYTHON_BIN" train.py \
  ...
  "opt.pose_correction_lr=8.0e-07" \
  "opt.texture_lr=0.0" \
  "opt.tex_latent_lr=0.0" \
  "++opt.camera_geometry_lr=6.0e-05" \
  "++opt.camera_geometry_strength=0.85" \
  "++opt.camera_geometry_rot_max_deg=0.36" \
  "++opt.camera_geometry_trans_max=0.008" \
