...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v192a_v189a_stable_interior_texture_$RUN_ID}"
...
exec env PYTHONUNBUFFERED=1 "$PYTHON_BIN" train.py \
  ...
  "++opt.perceptual_exclude_boundary_width=13" \
  "++opt.perceptual_stable_erode_kernel_size=3" \
  "++opt.perceptual_stable_min_pixels=96" \
  "++opt.perceptual_stable_fallback_to_source=true" \
  "++opt.patch_perceptual_min_mask_coverage=0.18" \
  ...
  "++opt.face_patch_perceptual_min_mask_coverage=0.12" \
  ...
  "++opt.shoulder_arm_patch_perceptual_min_mask_coverage=0.18" \
  "++opt.upper_torso_perceptual_exclude_boundary_width=13" \
  "++opt.upper_torso_perceptual_stable_erode_kernel_size=3" \
  "++opt.upper_torso_perceptual_stable_min_pixels=32" \
  "++opt.upper_torso_patch_perceptual_min_mask_coverage=0.18" \
  ...
  "++opt.upper_torso_core_patch_perceptual_min_mask_coverage=0.15" \
  "++opt.waist_perceptual_exclude_boundary_width=13" \
  "++opt.waist_perceptual_stable_erode_kernel_size=3" \
  "++opt.waist_perceptual_stable_min_pixels=32" \
  "++opt.waist_patch_perceptual_min_mask_coverage=0.18" \
  "++opt.lambda_l1_boundary=0.035" \
  "opt.lambda_mask=0.0" \
  "++opt.lambda_mask_boundary=0.002" \
  "++opt.lambda_mask_boundary_hard=0.004" \
  "++opt.lambda_silhouette_outer=0.003" \
  "++opt.lambda_silhouette_outer_shell=0.004" \
  "++opt.lambda_silhouette_inner=0.0015" \
  ...
  "++opt.lambda_perceptual_face=0.145" \
  "++opt.lambda_perceptual_shoulder_arm=0.060" \
  "++opt.lambda_perceptual_waist=0.038" \
  "++opt.lambda_perceptual_face_patch=0.105" \
  "++opt.lambda_perceptual_shoulder_arm_patch=0.058" \
  "++opt.lambda_perceptual_waist_patch=0.034" \
  "++opt.lambda_perceptual_upper_torso_patch=0.062" \
  "++opt.lambda_perceptual_upper_torso_core_patch=0.062" \
  ...
  "++opt.reliable_view_highfreq_max_weight=1.14" \
