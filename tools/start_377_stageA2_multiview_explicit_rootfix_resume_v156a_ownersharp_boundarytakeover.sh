...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v156a_v155b_ownersharp_boundarytakeover_screen3k}"
START_CKPT="${2:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v155b_v155a_ownerhf_handoff_cleanup_screen3k/best_ckpt.pth}"
ITERATIONS="${3:-3000}"
if [ "$#" -ge 3 ]; then
  shift 3
else
...
exec env PYTHONUNBUFFERED=1 "$PYTHON_BIN" "$ROOT/tools/run_377_stageA2_multiview_explicit.py" \
  ...
  --option stageA_377_multiview_explicit_hq_v155a_v152a_stagedlayer_geommain_v1 \
  --option stageA_377_multiview_explicit_hq_v155b_v155a_ownerhf_handoff_cleanup_v1 \
  --option stageA_377_multiview_explicit_hq_v156a_v155b_ownersharp_boundarytakeover_v1 \
