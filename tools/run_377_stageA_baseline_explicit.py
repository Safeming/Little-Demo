...
DEFAULT_OPTION_STACK = ['stageA_377_baseline_explicit_mono_v1']


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description='Stage A baseline-like reconstruction for CoreView_377: full image + original mask + no Hulk, while keeping explicit_binding.'
    )
