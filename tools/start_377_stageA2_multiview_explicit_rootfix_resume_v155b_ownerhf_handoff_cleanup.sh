...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v155b_v155a_ownerhf_handoff_cleanup_screen3k}"
START_CKPT="${2:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_fresh_v155a_v152a_stagedlayer_geommain_screen4k/best_ckpt.pth}"
ITERATIONS="${3:-3000}"
if [ "$#" -ge 3 ]; then
  shift 3
else
