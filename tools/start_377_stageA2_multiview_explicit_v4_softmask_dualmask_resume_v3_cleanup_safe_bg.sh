...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_v4_softmask_dualmask_resume_v3_cleanup_safe}"
...
setsid bash "$ROOT/tools/start_377_stageA2_multiview_explicit_v4_softmask_dualmask_resume_v3_cleanup_safe.sh" \
  "$EXP_DIR" \
  "$START_CKPT" \
