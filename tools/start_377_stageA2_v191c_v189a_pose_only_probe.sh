...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v191c_v189a_pose_only_probe_$RUN_ID}"
...
exec env PYTHONUNBUFFERED=1 "$PYTHON_BIN" train.py \
  ...
  "opt.pose_correction_lr=2.0e-07" \
  "opt.texture_lr=0.0" \
  "opt.tex_latent_lr=0.0" \
  "++opt.camera_geometry_lr=0.0" \
  "++opt.camera_geometry_strength=0.70" \
  "++opt.lambda_camera_geometry_reg=0.055" \
  ...
  "opt.lambda_pose=0.35" \
  "opt.lambda_l1=0.024" \
  "++opt.lambda_l1_fg=0.075" \
  "opt.lambda_perceptual=0.34" \
  ...
  "opt.lambda_mask=0.0" \
  "++opt.lambda_mask_boundary=0.004" \
  ...
  "++opt.lambda_perceptual_face=0.14" \
  "++opt.lambda_perceptual_shoulder_arm=0.058" \
  "++opt.lambda_perceptual_waist=0.038" \
  "++opt.lambda_perceptual_face_patch=0.10" \
  "++opt.lambda_perceptual_shoulder_arm_patch=0.052" \
  "++opt.lambda_perceptual_waist_patch=0.032" \
  "++opt.lambda_perceptual_upper_torso_patch=0.052" \
  "++opt.lambda_perceptual_upper_torso_core_patch=0.052" \
  ...
  "test_interval=150" \
  "test_iterations=[150,300,600,900]" \
  "save_iterations=[600,900]" \
  "checkpoint_iterations=[150,300,600,900]" \
