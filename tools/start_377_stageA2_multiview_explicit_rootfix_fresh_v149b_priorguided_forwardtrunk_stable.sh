...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_fresh_v149b_v149a_forwardtrunk_stable_router_screen4k}"
ITERATIONS="${2:-4000}"
if [ "$#" -ge 2 ]; then
  shift 2
else
...
exec env PYTHONUNBUFFERED=1 "$PYTHON_BIN" "$ROOT/tools/run_377_stageA2_multiview_explicit.py" \
  ...
  --option stageA_377_multiview_explicit_hq_v149b_v149a_forwardtrunk_stable_router_v1 \
