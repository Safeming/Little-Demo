...
EXP_DIR="${1:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v157c_v157b_signedfinishing_screen2k}"
START_CKPT="${2:-$ROOT/exp/stageA2/377_multiview_explicit_hq_rootfix_resume_v157b_v157a_ownerhf_sharphandoff_screen3k/best_ckpt.pth}"
ITERATIONS="${3:-2000}"
if [ "$#" -ge 3 ]; then
  shift 3
else
...
exec env PYTHONUNBUFFERED=1 "$PYTHON_BIN" "$ROOT/tools/run_377_stageA2_multiview_explicit.py" \
  ...
  --option stageA_377_multiview_explicit_hq_v157a_v152a_fresh_supportmain_v1 \
  --option stageA_377_multiview_explicit_hq_v157b_v157a_ownerhf_sharphandoff_v1 \
  --option stageA_377_multiview_explicit_hq_v157c_v157b_signedfinishing_v1 \
