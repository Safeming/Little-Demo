...
env \
  ...
  V247_ITERATIONS="${V247_ITERATIONS:-360}" \
  V247_CHECKPOINT_STEPS="${V247_CHECKPOINT_STEPS:-120,240,360}" \
  setsid bash "$ROOT/tools/run_377_stageB_v247_boundary_contributor_projector_serial.sh" \
  > "$NOHUP_LOG" 2>&1 &
