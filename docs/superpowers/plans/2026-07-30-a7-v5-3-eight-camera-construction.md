...
- [ ] Add failing tests for the v5.3 evidence freeze ID and the exact eight-camera sequence.
- [ ] Run the tests and confirm the contract is unsupported.
- [ ] Add the evidence contract validation and allow the builder to materialize 912 samples.
...
- [ ] Add failing tests for the v5.3 candidate ID and eight-fold capacity identity.
- [ ] Generate the formal evidence and record its SHA-256 and evidence contract fingerprint.
- [ ] Add the frozen candidate contract and v5.3 candidate mapping.
...
- [ ] Add failing tests requiring construction evidence identity, c21-c23 retrospective target/visibility gates, spatial gates, and `paper_test_eligible=false`.
- [ ] Implement the v5.3 summary and runner with stale-output and freeze-manifest checks.
- [ ] Run the focused tests and confirm they pass.
...
- [ ] Run formal eight-camera capacity and require 8/8 folds plus the frozen construction gates.
- [ ] Run the complete focused A7 regression, shell syntax, Python compilation, JSON validation, and `git diff --check`.
- [ ] Review the scoped diff for test leakage and marker correctness.
